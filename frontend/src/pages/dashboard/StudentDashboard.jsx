...
const StudentDashboard = () => {
  ...
  // User initials for the hero avatar
  ...
  // Shorten long department names for the badge
          ...
          >
            ...
            <div className="divide-y divide-neutral-100">
              {mockAnnouncements.map((item) => (
                <div
                  key={item.id}
                  className="px-6 py-4 hover:bg-neutral-50/50 transition-colors group cursor-pointer"
                >
          ...
          <div className="space-y-3">
            ...
            <div className={`flex gap-4 items-start p-4 rounded-xl border transition-all ${
              profileCompletion === 100
                ...
                : 'bg-brand-blue-light/40 border-brand-blue/10'
            }`}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-neutral-500 mt-0.5">
                  Add your academic details, 10th &amp; 12th marks, and resume to get verified by the admin.
                </p>
              </div>
              {profileCompletion !== 100 && (
                <button className="hidden sm:flex items-center gap-1 px-4 py-2 bg-brand-blue text-white text-xs font-semibold rounded-lg hover:bg-brand-blue-dark transition-colors shadow-sm">
                  Start
            ...
            <div className="flex gap-4 items-start p-4 rounded-xl border border-neutral-100 bg-neutral-50/50 opacity-60">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-neutral-400 mt-0.5">
                  Once your profile is complete, generate your standardized placement resume instantly.
                </p>
              </div>
              <span className="hidden sm:inline-block px-3 py-1 bg-neutral-200 text-neutral-500 text-[10px] font-semibold rounded-full">
                Locked
              </span>
            </div>

            {/* Step 3: Apply to Drives */}
            <div className="flex gap-4 items-start p-4 rounded-xl border border-neutral-100 bg-neutral-50/50 opacity-60">
              <div className="mt-0.5 flex-shrink-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-neutral-400 mt-0.5">
                  Browse eligible drives and apply with a single click once your profile is verified.
                </p>
              </div>
              <span className="hidden sm:inline-block px-3 py-1 bg-neutral-200 text-neutral-500 text-[10px] font-semibold rounded-full">
                Locked
